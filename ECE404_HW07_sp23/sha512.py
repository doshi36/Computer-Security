...
def sha512(input_txt, output_txt):
    ...
    input_bv = BitVector(textstring = input_txt.read())
    ...
    for n in range(0,bv4.length(),1024):
        ...
        #  that contains 128 64-bit words. This involves using the functions sigma0 and sigma1 as shown 
        #  below:
    ...
    output_txt.write(hash_hex_string)
